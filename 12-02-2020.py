...
lrLb.grid(row=20, column=0, pady=10)

destreeLb = Label(root, text="Random Forest", fg="white", bg="red")
destreeLb.grid(row=22, column=0, pady=10)

ranfLb = Label(root, text="Naive Bayes", fg="white", bg="red")
ranfLb.grid(row=24, column=0, pady=10)
...
#acc1 = Text(root, height=1, width=20,bg="orange",fg="black")
#acc1.grid(row=15, column=2, padx=10,sticky="e")
#
#
#acc2 = Text(root, height=1, width=20,bg="orange",fg="black")
#acc2.grid(row=17, column=2, padx=10,sticky="w")
#
#acc3 = Text(root, height=1, width=20,bg="orange",fg="black")
#acc3.grid(row=19, column=2, padx=10,sticky="e")

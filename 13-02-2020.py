...
def DecisionTree():
    ...
    if(Symptom1.get()=='Select Symptom'):
        ...
        print('DecisionTree : ',DecisionTree_acc)
...
def NaiveBayes():
    ...
    if(Symptom1.get()=='Select Symptom'):
        ...
        gnb = LogisticRegression(random_state=0).fit(X, y)
        
        log_acc=gnb.score(X_test,y_test)
...
NameEn = Entry(root, textvariable=Name,width=55)
...
destreeLb = Label(root, text="Random Forest", fg="white", bg="red", font='Arial 13')
destreeLb.place(x=350,y=650)

ranfLb = Label(root, text="Naive Bayes", fg="white", bg="red", font='Arial 13')
...
dst = Button(root, text="Decision Tree", command=DecisionTree,bg="green",fg="yellow", font='Arial 10')
dst.place(x=980,y=600)

rnf = Button(root, text="Random Forest", command=randomforest,bg="green",fg="yellow", font='Arial 10')
rnf.place(x=980,y=650)

lr = Button(root, text="Naive Bayes", command=NaiveBayes,bg="green",fg="yellow", font='Arial 10')
...
''' ONE TEXT BOX & FIVE OPTION BUTTONS   '''
